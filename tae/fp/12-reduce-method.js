...
which takes an initial value for the accumulator. 
...
function getRating(watchList) {
  let filtered = watchList.filter(el => el["Director"].match(/Christopher\sNolan/));
  return filtered.reduce((sum, movie) => sum + parseFloat(movie.imdbRating), 0) / filtered.length;
}
